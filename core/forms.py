...
class CheckoutForm(forms.Form):
    street_address = forms.CharField(widget=forms.TextInput(attrs={"placeholder":'124 Main St'}))
    ...
    same_info =  forms.BooleanField(widget = forms.CheckboxInput(), required=False)
